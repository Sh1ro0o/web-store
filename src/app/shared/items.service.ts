...
export class ItemsService {
  items: Item[] = [
    ...
    new Item('Doll', 30, 'Doll in a blue dress with curly hair', 'assets/images/doll.jpg'),
    ...
    new Item('Nutcracker', 15, 'Nutcracker plushie (not actually for cracking nuts)', 'assets/images/nutcracker.jpg'),
    new Item('Reindeer', 30, 'Raindeer plushie with a sweater, scarf and a red nose', 'assets/images/reindeer.jpg'),
    new Item('Race Car', 23, 'Blue race car plushie', 'assets/images/race-car.jpg'),
